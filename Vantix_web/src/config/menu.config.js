export const menuConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        labelKey: 'contract.details',
        title: 'Contract details',
        titleKey: 'contract.details',
        icon: 'Document',
        hidden: true,
        permissions: ['CONTRACT_VIEW'],
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/makeup-checkouts',
        name: 'MakeupCheckouts',
        label: 'Make-up Checkouts',
        labelKey: 'menu.makeupCheckouts',
        title: 'Make-up Checkouts',
        titleKey: 'menu.makeupCheckouts',
        icon: 'Clock',
        permissions: [
        ...
        permissionMode: 'any',
        component: () => import('@/views/MakeupCheckouts.vue'),
      },
    ],
  },
  {
