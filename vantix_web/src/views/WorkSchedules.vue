...
<template>
  <div class="page-card schedule-page">
    ...
    <el-dialog v-model="scheduleDialog.visible"
      ...
      width="600px" destroy-on-close class="schedule-dialog" align-center>
    ...
    <el-dialog v-model="shiftDialog.visible"
      ...
      width="520px" destroy-on-close class="schedule-dialog" align-center>
    ...
    <el-dialog v-model="bulkDialog.visible" :title="settings.t('schedule.bulk.add')"
      width="720px" destroy-on-close class="schedule-dialog" align-center>
