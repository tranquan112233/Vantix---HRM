...
public interface AttendanceRepository extends JpaRepository<Attendance, Integer> {
    ...
    List<Attendance> getMonthlyAttendance(@Param("employeeId") Long employeeId, @Param("month") int month, @Param("year") int year);
    ...
    Boolean isAlreadyCheckedIn(@Param("employeeId") Long employeeId, @Param("shiftId") Integer shiftId, @Param("workDate") LocalDate workDate);
    ...
    Optional<Attendance> findExistingAttendance(@Param("employeeId") Long employeeId, @Param("shiftId") Integer shiftId, @Param("workDate") LocalDate workDate);
