...
public class ScheduleController {
    ...
    @GetMapping
    public ResponseEntity<List<EmployeeScheduleDTO>> getSchedules(@RequestParam Integer viewerId, @RequestParam int month, @RequestParam int year) {
        try {
    ...
    public ResponseEntity<String> saveDailySchedules(@PathVariable Integer employeeId, @PathVariable int month, @PathVariable int year, @RequestBody List<DailyScheduleDTO> dailySchedules) {
        try {
