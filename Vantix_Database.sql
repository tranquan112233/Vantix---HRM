...
CREATE TABLE Contracts (
    ...
    contract_type ENUM('YEARS_1', 'YEARS_3', 'INDEFINITE'), -- Loại hợp đồng
...
CREATE TABLE Salaries (
    ...
    salary_month INT NOT NULL,                -- Tháng tính lương

    base_salary DECIMAL(15,2),                -- Lương cơ bản
    actual_shifts DECIMAL(4,1),			      -- Ngày công thực
    allowance DECIMAL(18,2),                  -- Phụ cấp
    oivertime_pay DECIMAL(18,2),              -- Tăng ca
...
CREATE TABLE Leave_Types (
    ...
    is_paid BOOLEAN DEFAULT TRUE                  -- Có hưởng lương hay không
);
